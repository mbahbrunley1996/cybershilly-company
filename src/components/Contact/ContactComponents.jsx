  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden border-b border-white/5">
        {/* Background Image with Tactical Grayscale */}
        ...
        <div className="absolute bottom-10 left-10 z-30 hidden md:block border-l border-b border-white/20 w-12 h-12"></div>
        <div className="absolute top-10 right-10 z-30 hidden md:block border-r border-t border-white/20 w-12 h-12"></div>
      </section>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h4 className="font-bold text-white uppercase text-sm">Priority Line</h4>
                    <p className="text-gray-400 font-mono tracking-tighter">+1 (301) SHILLY-B</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 font-mono tracking-tighter">uplink@shillybrittle.com</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7">
            <motion.div 
              ...
              className="bg-slate-900 border border-slate-800 p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden"
            >
              <AnimatePresence>
                {formState === "success" && (
                  <motion.div 
                  ...
                  >
                    ...
                    <button onClick={() => setFormState("idle")} className="mt-8 text-blue-500 hover:text-white transition-colors uppercase text-xs font-black tracking-widest">New Transmission</button>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 px-5 text-white focus:outline-none focus:border-blue-500 transition-all font-medium" placeholder="SHILLY BRITTLE" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Business Email</label>
                    <input required type="email" className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 px-5 text-white focus:outline-none focus:border-blue-500 transition-all font-medium" placeholder="SHILLYBRITTLE@GMAIL.COM" />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Subject / Interest Area</label>
                  <select className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 px-5 text-white focus:outline-none focus:border-blue-500 transition-all appearance-none font-medium">
                ...
                <div className="space-y-2">
                  ...
                  <textarea rows="5" className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 px-5 text-white focus:outline-none focus:border-blue-500 transition-all resize-none font-medium" placeholder="DESCRIBE CHALLENGE..."></textarea>
                </div>
      ...
      {/* Embedded Map Visual */}
      <section className="h-[500px] w-full bg-slate-950 border-t border-white/10 relative">
        <div className="absolute inset-0 pointer-events-none z-10 bg-gradient-to-b from-slate-950/40 via-transparent to-slate-950/40"></div>
        <iframe
          title="Maryland HQ Location"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d198064.08987483756!2d-76.77884214282361!3d39.06240217937965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89b78a994784407b%3A0xc3f958897e937d34!2sMaryland!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
          width="100%"
          height="100%"
          style={{ border: 0, filter: 'invert(100%) hue-rotate(180deg) brightness(0.6) contrast(0.9)' }}
          allowFullScreen=""
          loading="lazy"
        ></iframe>
      </section>
